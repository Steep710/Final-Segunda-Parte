...
<html lang="{{ app()->getLocale() }}">
  ...
  <div class="main-banner">
    <div id="contenido-header" class="center-page">
  <div class="content-header-left">
    <div class="banner">
          <div class="text-header titu-iz">GREAT SMARTPHONE APP<br>
             JUST FOR YOU!
           </div>
          <div class=" mini-header conte-iz">
  ...
  <img class="alignnone size-full wp-image-3404" src="images/cell.png" alt="" width="308" height="544" />
  </div>
  </div>
  </div>
